...
public class ResponseConstants {
    ...
    public static final String JSON_RESPONSE = ":application/json:Accept:authorization:Cache-Control:Connection:"
            + "Content-Length:content-type:Host:Pragma::/petstore/v1/user?test=value1&test2=value2:POST:1.1:"
            + "test2=value2 test=value1:value1:{\"hello\":\"world\"}";
    public static final String XML_RESPONSE = ":text/xml:Accept:authorization:Cache-Control:Connection:Content-Length:"
