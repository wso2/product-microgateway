...
public class HttpsPostMultipart {
     ...
     * @throws IOException
     */
    public HttpsPostMultipart(String requestURL, Map<String, String> headers, String trustStorepath) throws IOException {

        HttpsClientRequest.setSSlSystemProperties(trustStorepath);
