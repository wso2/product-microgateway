 ...
 */
public class CcStartupExecutorWithRatelimit extends ApimBaseTest {
    ...
    public void startChoreoConnect() throws Exception {
        ccInstance = new CcInstance.Builder()
                .withNewDockerCompose("cc-in-common-network-with-ratelimit-docker-compose.yaml")
                .withNewConfig("controlplane-enabled-config-with-ratelimit.toml")
