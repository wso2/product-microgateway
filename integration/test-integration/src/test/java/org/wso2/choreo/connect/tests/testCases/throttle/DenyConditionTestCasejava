...
public class DenyConditionTestCase extends ThrottlingBaseTestCase {
    ...
    public void testIPDenyPolicyThrottling() throws Exception {
        ...
        ApiResponse<BlockingConditionDTO> ipResponse = restAPIAdmin.addDenyThrottlingPolicy(ipCondition);
        ...
        restAPIAdmin.deleteDenyThrottlingPolicy(ipResponse.getData().getConditionId());
        waitForXdsDeployment();
        requestHeaders.put(HttpHeaders.X_FORWARDED_FOR, fixedIp);
    ...
    public void testAPIDenyPolicyThrottling() throws Exception {
        ...
        ApiResponse<BlockingConditionDTO> apiResponse = restAPIAdmin.addDenyThrottlingPolicy(apiCondition);
        waitForXdsDeployment();
        ...
        restAPIAdmin.deleteDenyThrottlingPolicy(apiResponse.getData().getConditionId());
        waitForXdsDeployment();
    ...
    public void testApplicationDenyPolicyThrottling() throws Exception {
        ...
        ApiResponse<BlockingConditionDTO> appResponse = restAPIAdmin.addDenyThrottlingPolicy(appCondition);
        waitForXdsDeployment();
        ...
        restAPIAdmin.deleteDenyThrottlingPolicy(appResponse.getData().getConditionId());
        waitForXdsDeployment();
    ...
    public void testUserDenyPolicyThrottling() throws Exception {
        ...
        ApiResponse<BlockingConditionDTO> userResponse = restAPIAdmin.addDenyThrottlingPolicy(userCondition);
        waitForXdsDeployment();
        ...
        restAPIAdmin.deleteDenyThrottlingPolicy(userResponse.getData().getConditionId());
        waitForXdsDeployment();
