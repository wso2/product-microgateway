...
import org.wso2.gateway.discovery.service.keyManagerConfig.KMDiscoveryServiceGrpc;
import org.wso2.micro.gateway.enforcer.config.ConfigHolder;
import org.wso2.micro.gateway.enforcer.constants.Constants;
import org.wso2.micro.gateway.enforcer.exception.DiscoveryException;
import org.wso2.micro.gateway.enforcer.keymanager.KeyManagerHolder;
...
public class KeyManagerDiscoveryClient {
    ...
    public void watchKeyManagers() {
        // TODO: (Hiranya) implement a deadline with retries
        reqObserver = stub.streamKeyManagers(new StreamObserver<DiscoveryResponse>() {
            @Override
            public void onNext(DiscoveryResponse response) {
                ...
                try {
                    ...
                    // TODO: (Hiranya) fix recursive ack on ack failure
                    ack();
                } catch (Exception e) {
                    // catching generic error here to wrap any grpc communication errors in the runtime
                    onError(e);
            ...
            public void onError(Throwable throwable) {
                ...
                // TODO: (Hiranya) if adapter is unavailable keep retrying
                nack(throwable);
            }
