...
type Api struct {
	...
	DisableBackendJWT   bool              `protobuf:"varint,20,opt,name=disableBackendJWT,proto3" json:"disableBackendJWT,omitempty"`
}
...
func (x *Api) GetDisableBackendJWT() bool {
	if x != nil {
		return x.DisableBackendJWT
	}
	return false
}
...
var file_wso2_discovery_api_api_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x89, 0x07, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12, 0x0e,
	...
	0x69, 0x64, 0x65, 0x72, 0x12, 0x2c, 0x0a, 0x11, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x42,
	0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x4a, 0x57, 0x54, 0x18, 0x14, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x11, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x4a,
	0x57, 0x54, 0x42, 0x72, 0x0a, 0x25, 0x6f, 0x72, 0x67, 0x2e, 0x77, 0x73, 0x6f, 0x32, 0x2e, 0x63,
