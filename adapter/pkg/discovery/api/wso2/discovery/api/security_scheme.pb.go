...
type SecurityScheme struct {
	...
	Type string `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"` // type of the security scheme
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"` // name of the security scheme
	In   string `protobuf:"bytes,3,opt,name=in,proto3" json:"in,omitempty"`     // location of the API key
}
...
var file_wso2_discovery_api_security_scheme_proto_rawDesc = []byte{
	...
	0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x2e, 0x61, 0x70, 0x69, 0x22, 0x48,
	...
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x6e, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x6e, 0x42, 0x7d, 0x0a, 0x25, 0x6f, 0x72, 0x67, 0x2e,
	...
	0x69, 0x42, 0x13, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x53, 0x63, 0x68, 0x65, 0x6d,
...
var file_wso2_discovery_api_security_scheme_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
