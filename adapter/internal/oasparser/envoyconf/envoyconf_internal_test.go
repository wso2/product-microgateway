...
func TestCreateRoute(t *testing.T) {
	...
	version := "1.0"
	resourceWithGet := model.CreateMinimalDummyResourceForTests("/resourcePath", []*model.Operation{model.NewOperation("GET", nil, nil, model.PrototypeConfig{})},
		"resource_operation_id", []model.Endpoint{}, []model.Endpoint{})
	resourceWithGetPost := model.CreateMinimalDummyResourceForTests("/resourcePath", []*model.Operation{model.NewOperation("GET", nil, nil, model.PrototypeConfig{}), model.NewOperation("POST", nil, nil, model.PrototypeConfig{})},
		"resource_operation_id", []model.Endpoint{}, []model.Endpoint{})
