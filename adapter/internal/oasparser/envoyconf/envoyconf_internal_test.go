...
func TestCreateRoute(t *testing.T) {
	...
	version := "1.0"
	resourceWithGet := model.CreateMinimalDummyResourceForTests("/resourcePath", []*model.Operation{model.NewOperation("GET", nil, nil, model.MockedAPIConfig{})},
		"resource_operation_id", []model.Endpoint{}, []model.Endpoint{})
	resourceWithGetPost := model.CreateMinimalDummyResourceForTests("/resourcePath", []*model.Operation{model.NewOperation("GET", nil, nil, model.MockedAPIConfig{}), model.NewOperation("POST", nil, nil, model.MockedAPIConfig{})},
		"resource_operation_id", []model.Endpoint{}, []model.Endpoint{})
