 ...
 */
 ...
 func getGzipConfigurations(config config.Config) *gzip_compressor.Gzip {
	 ...
	 if memoryLevel != 0 {
		 ...
		 logger.LoggerOasparser.Error("Error while parsing the gzip configuration value for the memory level. ", err1)
	 }
	 ...
	 if windowBits != 0 && err2 == nil {
		 ...
		 logger.LoggerOasparser.Error("Error while parsing the gzip configuration value for the window bits", err2)
	 }
	 ...
	 if compressionLevel != 0 && err3 == nil {
		 ...
		 logger.LoggerOasparser.Error("Error while parsing the gzip configuration value for the compression level", err3)
	 }
	 ...
	 if chunkSize != 0 && err4 == nil {
		 ...
		 logger.LoggerOasparser.Error("Error while parsing the gzip configuration value for the chunk size", err4)
	 }
