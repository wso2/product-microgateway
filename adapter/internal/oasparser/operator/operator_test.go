			...
			resultApiProdEndpoints: []model.Endpoint{
				{
					...
					Port:     80,
					URLType:  "http",
					RawURL:   "http://petstore.io:80/api/v2",
				},
			},
			...
			resultApiProdEndpoints: []model.Endpoint{
				{
					...
					Port:     80,
					URLType:  "https",
					RawURL:   "https://petstore.io:80/api/v2",
				},
			},
			resultResourceProdEndpoints: nil,
			...
			resultApiProdEndpoints: []model.Endpoint{
				{
					...
					Port:     90,
					URLType:  "https",
					RawURL:   "https://petstorecorrect.swagger.io:90/api/v3",
				},
			},
			resultResourceProdEndpoints: nil,
...
func testGetOpenAPIVersionAndJSONContent(t *testing.T, apiYamlFilePath string) {
	...
	if strings.HasSuffix(apiYamlFilePath, "/openapi_with_prod_sand_extensions.yaml") {
		assert.Equal(t, constants.Swagger2, versionOfAPI, "Swagger version mismatch")
	}
