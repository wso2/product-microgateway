...
public class ApplicationDiscoveryClient implements Runnable, DiscoveryClient {
        ...
        reqObserver = stub.withMaxInboundMessageSize(maxSize)
            ...
            public void onNext(DiscoveryResponse response) {
                ...
                try {
                    ...
                    logger.info("Application discovery response acked after " + sendDuration + " ms");
     ...
     */
    private void ack() {
        logger.debug("Applied Discovery Response for type url: " + Constants.APPLICATION_LIST_TYPE_URL
