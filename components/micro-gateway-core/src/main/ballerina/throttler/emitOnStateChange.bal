...
public function emitOnStateChange(any[] windowParameters, function (streams:StreamEvent?[])? nextProcessPointer = ())
                    returns streams:Window {
    EmitOnStateChange stateChangeProcessor = new(nextProcessPointer, windowParameters);
