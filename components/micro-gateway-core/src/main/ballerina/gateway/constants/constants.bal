...
public const string UNPROCESSABLE_ENTITY_DESCRIPTION =
    "Unable to process the given entity.Please check whether the provided entity is correct.";
...
// logging keys
public const string KEY_GW_LISTNER = "APIGatewayListener";
public const string KEY_AUTHN_FILTER = "AuthnFilter";
public const string KEY_AUTHZ_FILTER = "AuthzFilter";
public const string KEY_SUBSCRIPTION_FILTER = "SubscriptionFilter";
public const string KEY_THROTTLE_FILTER = "ThrottleFilter";
public const string KEY_ANALYTICS_FILTER = "AnalyticsFilter";
public const string KEY_MUTUAL_SSL_FILTER = "MutualSSLFilter";
public const string KEY_VALIDATION_FILTER = "ValidationFilter";
public const string KEY_BASIC_AUTH_FILTER = "BasicAuthFilter";
public const string KEY_THROTTLE_UTIL = "ThrottleUtil";
public const string KEY_GW_CACHE = "GatewayCache";
public const string KEY_UTILS = "Utils";
public const string KEY_OAUTH_PROVIDER = "OAuthAuthProvider";
public const string KEY_UPLOAD_TASK = "UploadTimerTask";
public const string KEY_ROTATE_TASK = "RotateTimerTask";
public const string KEY_ETCD_UTIL = "EtcdUtil";
