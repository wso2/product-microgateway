...
function initApplication50PerMinPolicy() {
    ...
    forever {
        ...
        select messageID, (appTier == "50PerMin") as isEligible, appKey as throttleKey
        ...
        select throttleKey, count(messageID) >= 50 as isThrottled, true as stopOnQuota, expiryTimeStamp
