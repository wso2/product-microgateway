...
function initApplication10PerMinPolicy() {
    ...
    forever {
        ...
        select messageID, (appTier == "10PerMin") as isEligible, appKey as throttleKey
        ...
        select throttleKey, count(messageID) >= 10 as isThrottled, true as stopOnQuota, expiryTimeStamp
