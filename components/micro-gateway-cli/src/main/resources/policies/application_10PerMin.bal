...
function initApplication10PerMinPolicy() {
    ...
    forever {
        ...
        select s10PerMineligibilityStream.throttleKey as throttleKey, count() as eventCount, true as stopOnQuota,
        ...
        select s10PerMinintermediateStream.throttleKey, getThrottleValues10PerMin(s10PerMinintermediateStream.eventCount
        ) as isThrottled, s10PerMinintermediateStream.stopOnQuota, s10PerMinintermediateStream.expiryTimeStamp
        group by s10PerMineligibilityStream.throttleKey
        ...
        window gateway:emitOnStateChange(s10PerMinresultStream.throttleKey, s10PerMinresultStream.isThrottled,
            "s10PerMinresultStream")
