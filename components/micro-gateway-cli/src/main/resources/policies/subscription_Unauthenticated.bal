...
function initSubscriptionUnauthenticatedPolicy() {
    ...
    forever {
        ...
        select messageID, (subscriptionTier == "Unauthenticated") as isEligible, subscriptionKey as throttleKey
        ...
        select throttleKey, count(messageID) >= 500 as isThrottled, true as stopOnQuota, expiryTimeStamp
