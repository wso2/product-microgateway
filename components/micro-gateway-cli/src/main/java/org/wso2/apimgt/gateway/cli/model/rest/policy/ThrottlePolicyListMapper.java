...
public class ThrottlePolicyListMapper {
    ...
    public void setResourcePolicies(List<ThrottlePolicyMapper> resourcePolicies) {
    ...
    public void setApplicationPolicies(List<ThrottlePolicyMapper> applicationPolicies) {
    ...
    public void setSubscriptionPolicies(List<ThrottlePolicyMapper> subscriptionPolicies) {
