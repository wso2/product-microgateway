...
public class MgwWithJwtConfigAndTransformer extends BaseTestCase {
    ...
    @BeforeTest(groups = { TestGroup.MGW_WITH_JWT_CONFIG_AND_TRANSFORMER }, description = "initialise the setup")
    ...
    @AfterTest(groups = { TestGroup.MGW_WITH_JWT_CONFIG_AND_TRANSFORMER }, description = "stop the setup")
    void stop() {
        super.stopMGW();
    }
}
