...
public class MgwWithOneAPI extends BaseTestCase {

    @BeforeTest(groups = { TestGroup.MGW_WITH_ONE_API }, description = "initialise the setup")
    ...
    @AfterTest(groups = { TestGroup.MGW_WITH_ONE_API }, description = "stop the setup")
    void stop() {
        super.stopMGW();
    }
}
