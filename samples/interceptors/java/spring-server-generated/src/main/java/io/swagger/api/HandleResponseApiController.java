...
public class HandleResponseApiController implements HandleResponseApi {
    ...
    public ResponseEntity<ResponseHandlerResponseBody> handleResponse(@Parameter(in = ParameterIn.DEFAULT, description = "Content of the request
", schema=@Schema()) @Valid @RequestBody ResponseHandlerRequestBody body) {
